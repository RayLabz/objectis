...
Gradle:
```xml
implementation 'com.raylabz:objectis:0.0.4'
```

Download as .jar file:

[Download](https://oss.sonatype.org/service/local/artifact/maven/redirect?r=releases&g=com.raylabz&a=objectis&v=0.0.4&e=jar)
